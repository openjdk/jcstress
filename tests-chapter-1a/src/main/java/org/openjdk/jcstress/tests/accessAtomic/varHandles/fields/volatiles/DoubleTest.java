 ...
 * questions.
 */
package org.openjdk.jcstress.tests.accessAtomic.varHandles.fields.volatiles;
...
public class DoubleTest {
    ...
    static {
        try {
            VH = MethodHandles.lookup().findVarHandle(DoubleTest.class, "x", double.class);
    ...
    @Actor
    public void actor1() {
        VH.setVolatile(this, 1.39067116124321E-309);
    }

    @Actor
    public void actor2(DoubleResult1 r) {
        r.r1 = (double)VH.getVolatile(this);
    }
