 ...
 * questions.
 */
package org.openjdk.jcstress.tests.tearing.arrays.small.volatiles;
...
public class FloatTest {
    ...
    volatile float[] arr = new float[2];

    @Actor
    public void actor1() {
        arr[0] = 2.3509528E-38F;
    }

    @Actor
    public void actor2() {
        arr[1] = 2.3509528E-38F;
    }

    @Arbiter
    public void arbiter(FloatResult2 r) {
        r.r1 = arr[0];
        r.r2 = arr[1];
    }
