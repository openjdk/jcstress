...
public class AtomicLongPairwiseTests {
    ...
    public static class AddAndGet_AddAndGet {
        @Actor public void actor1(S s, JJ_Result r) { r.r1 = s.addAndGet(5); }
        @Actor public void actor2(S s, JJ_Result r) { r.r2 = s.addAndGet(5); }
    }
    ...
    public static class AddAndGet_DecAndGet {
        @Actor public void actor1(S s, JJ_Result r) { r.r1 = s.addAndGet(5); }
        @Actor public void actor2(S s, JJ_Result r) { r.r2 = s.decrementAndGet(); }
    }
    ...
    public static class AddAndGet_GetAndAdd {
        @Actor public void actor1(S s, JJ_Result r) { r.r1 = s.addAndGet(5); }
        @Actor public void actor2(S s, JJ_Result r) { r.r2 = s.getAndAdd(5); }
    }
    ...
    public static class AddAndGet_GetAndDec {
        @Actor public void actor1(S s, JJ_Result r) { r.r1 = s.addAndGet(5); }
        @Actor public void actor2(S s, JJ_Result r) { r.r2 = s.getAndDecrement(); }
    }
    ...
    public static class AddAndGet_GetAndInc {
        @Actor public void actor1(S s, JJ_Result r) { r.r1 = s.addAndGet(5); }
        @Actor public void actor2(S s, JJ_Result r) { r.r2 = s.getAndIncrement(); }
    }
    ...
    public static class AddAndGet_GetAndSet {
        @Actor public void actor1(S s, JJ_Result r) { r.r1 = s.addAndGet(5); }
        @Actor public void actor2(S s, JJ_Result r) { r.r2 = s.getAndSet(10); }
    }
    ...
    public static class AddAndGet_IncAndGet {
        @Actor public void actor1(S s, JJ_Result r) { r.r1 = s.addAndGet(5); }
        @Actor public void actor2(S s, JJ_Result r) { r.r2 = s.incrementAndGet(); }
    }
    ...
    public static class AddAndGet_CAS {
        @Actor public void actor1(S s, JJ_Result r) { r.r1 = s.addAndGet(5); }
        @Actor public void actor2(S s, JJ_Result r) { r.r2 = s.compareAndSet(0, 20) ? 20 : 10; }
    }
    ...
    public static class AddAndGet_WCAS {
        @Actor public void actor1(S s, JJ_Result r) { r.r1 = s.addAndGet(5); }
        @Actor public void actor2(S s, JJ_Result r) { r.r2 = s.weakCompareAndSet(0, 20) ? 20 : 10; }
    }
    ...
    public static class AddAndGet_Set {
        @Actor public void actor1(S s, JJ_Result r) { r.r1 = s.addAndGet(5); }
        @Actor public void actor2(S s, JJ_Result r) { s.set(10); r.r2 = 0; }
    }
    ...
    public static class DecAndGet_DecAndGet {
        @Actor public void actor1(S s, JJ_Result r) { r.r1 = s.decrementAndGet(); }
        @Actor public void actor2(S s, JJ_Result r) { r.r2 = s.decrementAndGet(); }
    }
    ...
    public static class GetAndAdd_GetAndAdd {
        @Actor public void actor1(S s, JJ_Result r) { r.r1 = s.getAndAdd(5); }
        @Actor public void actor2(S s, JJ_Result r) { r.r2 = s.getAndAdd(5); }
    }
    ...
    public static class GetAndDec_GetAndDec {
        @Actor public void actor1(S s, JJ_Result r) { r.r1 = s.getAndDecrement(); }
        @Actor public void actor2(S s, JJ_Result r) { r.r2 = s.getAndDecrement(); }
    }
    ...
    public static class GetAndInc_GetAndInc {
        @Actor public void actor1(S s, JJ_Result r) { r.r1 = s.getAndIncrement(); }
        @Actor public void actor2(S s, JJ_Result r) { r.r2 = s.getAndIncrement(); }
    }
    ...
    public static class GetAndSet_GetAndSet {
        @Actor public void actor1(S s, JJ_Result r) { r.r1 = s.getAndSet(5); }
        @Actor public void actor2(S s, JJ_Result r) { r.r2 = s.getAndSet(10); }
    }
    ...
    public static class IncAndGet_IncAndGet {
        @Actor public void actor1(S s, JJ_Result r) { r.r1 = s.incrementAndGet(); }
        @Actor public void actor2(S s, JJ_Result r) { r.r2 = s.incrementAndGet(); }
    }
    ...
    public static class CAS_CAS {
        @Actor public void actor1(S s, JJ_Result r) { r.r1 = s.compareAndSet(0, 5) ? 5 : 1; }
        @Actor public void actor2(S s, JJ_Result r) { r.r2 = s.compareAndSet(0, 20) ? 20 : 10; }
    }
    ...
    public static class WCAS_WCAS {
        @Actor public void actor1(S s, JJ_Result r) { r.r1 = s.weakCompareAndSet(0, 5) ? 5 : 1; }
        @Actor public void actor2(S s, JJ_Result r) { r.r2 = s.weakCompareAndSet(0, 20) ? 20 : 10; }
    }
    ...
    public static class Set_Set {
        @Actor public void actor1(S s, J_Result r) { s.set(5); }
        @Actor public void actor2(S s, J_Result r) { s.set(10); }
        @Arbiter public void arbiter1(S s, J_Result r) { r.r1 = s.get(); }
    }
