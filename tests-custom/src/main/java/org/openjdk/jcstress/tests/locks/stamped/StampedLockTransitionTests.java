...
public class StampedLockTransitionTests {
    ...
    public static class OO_OO {
        @Actor public void actor1(S s, II_Result r) { r.r1 = s.optimistic_optimistic(); }
        @Actor public void actor2(S s, II_Result r) { r.r2 = s.optimistic_optimistic(); }
    }
    ...
    public static class OO_OR {
        @Actor public void actor1(S s, II_Result r) { r.r1 = s.optimistic_optimistic(); }
        @Actor public void actor2(S s, II_Result r) { r.r2 = s.optimistic_read(); }
    }
    ...
    public static class OO_OW {
        @Actor public void actor1(S s, II_Result r) { r.r1 = s.optimistic_optimistic(); }
        @Actor public void actor2(S s, II_Result r) { r.r2 = s.optimistic_write(); }
    }
    ...
    public static class OR_OW {
        @Actor public void actor1(S s, II_Result r) { r.r1 = s.optimistic_read(); }
        @Actor public void actor2(S s, II_Result r) { r.r2 = s.optimistic_write(); }
    }
    ...
    public static class RO_RO {
        @Actor public void actor1(S s, II_Result r) { r.r1 = s.read_optimistic(); }
        @Actor public void actor2(S s, II_Result r) { r.r2 = s.read_optimistic(); }
    }
    ...
    public static class RO_RR {
        @Actor public void actor1(S s, II_Result r) { r.r1 = s.read_optimistic(); }
        @Actor public void actor2(S s, II_Result r) { r.r2 = s.read_read(); }
    }
    ...
    public static class RO_RW {
        @Actor public void actor1(S s, II_Result r) { r.r1 = s.read_optimistic(); }
        @Actor public void actor2(S s, II_Result r) { r.r2 = s.read_write(); }
    }
    ...
    public static class RR_RW {
        @Actor public void actor1(S s, II_Result r) { r.r1 = s.read_read(); }
        @Actor public void actor2(S s, II_Result r) { r.r2 = s.read_write(); }
    }
    ...
    public static class WO_WO {
        @Actor public void actor1(S s, II_Result r) { r.r1 = s.write_optimistic(); }
        @Actor public void actor2(S s, II_Result r) { r.r2 = s.write_optimistic(); }
    }
    ...
    public static class WO_WR {
        @Actor public void actor1(S s, II_Result r) { r.r1 = s.write_optimistic(); }
        @Actor public void actor2(S s, II_Result r) { r.r2 = s.write_read(); }
    }
    ...
    public static class WO_WW {
        @Actor public void actor1(S s, II_Result r) { r.r1 = s.write_optimistic(); }
        @Actor public void actor2(S s, II_Result r) { r.r2 = s.write_write(); }
    }
    ...
    public static class WR_WW {
        @Actor public void actor1(S s, II_Result r) { r.r1 = s.write_read(); }
        @Actor public void actor2(S s, II_Result r) { r.r2 = s.write_write(); }
    }
