...
@Outcome(              expect = Expect.FORBIDDEN, desc = "Seeing the torn value. This is not allowed")
@State
public class DoubleAtomicityTest {
    ...
    static {
        try {
            VH = MethodHandles.lookup().findVarHandle(DoubleAtomicityTest.class, "x", double.class);
    ...
    @Actor
    public void actor1() {
        VH.setOpaque(this, Constants.DOUBLE_SAMPLE);
    }
